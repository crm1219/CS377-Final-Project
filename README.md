...
* Test all changes thoroughly before you push them
* Limit the number of changes made per commit to make it easier to undo them if necessary
* Ensure all pull requests are reviewed by at least one other person
* Add comments to your code to ensure it is understandable
